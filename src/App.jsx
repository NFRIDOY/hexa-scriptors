...
function App() {
	...
	return (
      ...
      <Mustafiz></Mustafiz>
        ...
        <button className="btn " onClick={() => {alert("Mustafiz Rahman")}}> another button by Mustafiz </button>
			...
			<div>
				...
				<dialog id="my_modal_1" className="modal">
					<div className="modal-box">
						...
						<p className="py-4">
							A student on an intellectual journey, painting the
							canvas of learning with strokes of curiosity and
							imagination.
						</p>
